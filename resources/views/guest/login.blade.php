                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                        ...
                        <form class="form w-100" action="{{ route('authenticate') }}" method="POST">
                            ...
                            <div class="text-center mb-11">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder mb-3 pb-4">Andalalin</h1>
                                {{-- <img alt="Logo" style="width: 50%"
                                    src="{{ asset('./assets/media/logos/pupr.png') }}" />
                                <img alt="Logo" style="width: 25%"
                                    src="{{ asset('./assets/media/logos/pemkab.png') }}" /> --}}
                                <h1 class="text-dark fw-bolder mb-3 mt-5">Masuk</h1>
                                <!--end::Title-->
                            </div>
                            <!--end::Login options-->
                            <!--end::Separator-->
