                                                ...
                                                <td>
                                                    ...
                                                    @if ($tanggalTinjauan > $tanggalSekarang)
                                                        <button data-bs-toggle="modal" data-bs-target="#exampleModal"
                                                            class="btn btn-warning btn-sm">Ubah Jadwal Tinjauan
                                                            Lapangan</button>
                                                    @endif
                                                </td>
                                            </tr>
                                    ...
                                    <div class="col-12 mt-5">
                                        @if (!$pengajuan->hasOneJadwalTinjauan->is_review)
                                            <form id="tinjauanLapangan"
                                                action="{{ route('admin.telah.melakukan.tinjauan', $pengajuan->hasOneJadwalTinjauan->id) }}"
                                                method="POST">
                                                @csrf
