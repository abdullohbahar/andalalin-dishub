...
@section('content')
    ...
    <!--end::Content wrapper-->
    @include('admin.pengajuan.buat-jadwal.components.modal-buat-jadwal')
    @include('admin.pengajuan.buat-jadwal.components.modal-detail-jadwal')
@endsection
            ...
            var exampleSelect = function() {
                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    eventClick: function(arg) {
                        ...
                        $.ajax({
                            url: "/admin/pengajuan/ajax/get-detai-jadwal/" + pengajuanid,
                            method: "GET",
                            dataType: "JSON",
                            success: function(response) {
                                ...
                                var nama_proyek = response.data.nama_proyek;
                                var tanggal_tinjauan = response.data.tanggal_tinjauan;

                                $("#namaProyek").text(nama_proyek)
                                $("#alamat").text(alamat)
